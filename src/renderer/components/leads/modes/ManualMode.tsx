...
export default function ManualMode({
  ...
  const [hasConjoint, setHasConjoint] = useState(!!formData.conjoint)
  ...
  const updateSouscripteur = (field: string, value: string | number) => {
    onFormDataChange({
      ...formData,
      souscripteur: { ...formData.souscripteur, [field]: value }
    })
  }
  ...
  const updateConjoint = (field: string, value: string) => {
    onFormDataChange({
      ...formData,
      conjoint: { ...formData.conjoint, [field]: value }
    })
  }
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (!e.target.checked) {
                      onFormDataChange({ ...formData, conjoint: undefined })
                    } else {
                      onFormDataChange({
                        ...formData,
                        conjoint: {
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onFormDataChange({
                    ...formData,
                    besoins: { ...formData.besoins, dateEffet: e.target.value }
                  })}
                  className="w-full px-3 py-2 rounded-md border border-neutral-300 dark:border-neutral-700 bg-transparent"
                />
              </div>
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => onFormDataChange({
                    ...formData,
                    besoins: { ...formData.besoins, assureActuellement: e.target.checked }
                  })}
                  className="rounded border-neutral-300 dark:border-neutral-700"
                />
